// src/app/embed/tbai-assistants/foreclosure/page.tsx
'use client';

import { Suspense } from 'react';
import { ErrorBoundary } from 'react-error-boundary';
import Foreclosure from '@/components/custom/Foreclosure';
...
export default function ForeclosurePage() {
  const handleError = (error: Error) => {
    console.error('Error in Foreclosure Character:', error);
  };
